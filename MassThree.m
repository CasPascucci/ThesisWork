...
lb = [0.1, 4.2, 0.5];    % Lower bounds - avoid zero/negative values
...
plot(t_traj, vecnorm(aT_list, 2, 2), 'y--', 'LineWidth', 2);
...
plot(t_traj * T_ref, vecnorm(aT_list, 2, 2) * A_ref, 'y--', 'LineWidth', 2);
...
figure(4);
plot(t_traj, mass_list, 'b-', 'LineWidth', 2);
hold on;
