...
clear; clc; close all;
 ...
 %gamma_list = [logspace(log10(0.001), log10(1), 8), 2, 3]; % n = 10
 %kr_list = linspace(0, 20, 50);
 %tgo_list = linspace(5, 20, 20);
gamma_list = 1.0;
kr_list = linspace(0, 20, 5) + 1e-4;
%kr_list = 6;
%tgo_list = linspace(5, 15, 3);
tgo_list = 5;
